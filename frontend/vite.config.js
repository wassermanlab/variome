...
export default defineConfig({
  ...
  plugins: [
    ...
    viteStaticCopy({
      silent: true,
      targets: [
        { src: 'content/**/*.png', dest: '.', rename: { stripBase: 1 } },
        { src: 'content/**/*.svg', dest: '.', rename: { stripBase: 1 } },
        { src: 'content/**/*.ico', dest: '.', rename: { stripBase: 1 } },
        { src: 'content/manifest.json', dest: '.', rename: { stripBase: 1 } },
        { src: 'content/robots.txt', dest: '.', rename: { stripBase: 1 } },
      ]
    })
  ],
  define
